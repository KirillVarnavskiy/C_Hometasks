...
Console.Clear();
Console.Write("Enter the size of the three-dimensional array, according to the terms of the task: ");
int[] size = Console.ReadLine().Split(" ").Select(x => int.Parse(x)).ToArray();
while (size[0] * size[1] * size[2] > 90)
{
    Console.Write("Invalid values entered!\nEnter the size of the three-dimensional array, according to the terms of the task: ");
